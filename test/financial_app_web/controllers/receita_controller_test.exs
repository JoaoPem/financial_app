defmodule FinancialAppWeb.ReceitaControllerTest do
  use FinancialAppWeb.ConnCase

  import FinancialApp.FinanceFixtures

  @create_attrs %{categoria: "some categoria", data: ~D[2024-11-17], nome: "some nome", valor: "120.5"}
  ...
  describe "update receita" do
    ...
    test "redirects when data is valid", %{conn: conn, receita: receita} do
      ...
      assert html_response(conn, 200) =~ "some updated categoria"
    end
